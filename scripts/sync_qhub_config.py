...
def build_config(cur) -> dict:
    ...
    return {
        ...
        "personality": (
            ...
            "\n"
            "بداية كل مكالمة: عرّفي بنفسك أولاً ثم اسألي — قولي الترحيب "
            "المحدد لك حرفياً: «حياك الله في كيو هَب، معك دانة، وش أقدر "
            "أخدمك؟». لا تختصريه ولا تحذفي اسمك أو اسم الحاضنة منه.\n"
            "\n"
